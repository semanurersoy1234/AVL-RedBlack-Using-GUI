/**
  * @file ce205-hw2-emirhan-asik
  * @author Emirhan ASIK
  * @date 03 November 2022
  *
  * @brief <b> HW-2 Functions </b>
  *
  * CE205 Week-7 HW-2 03.10.2022
  *
...
namespace GraphShortest
{
    partial class MnFrm : Form
    {
        ...
        private void btniter_Click(object sender, EventArgs e)
        {
            ...
            {
                textBox1.Text = "A Minimum Spanning Tree(MST) or minimum weight spanning tree for a weighted, connected, undirected graph is a spanning tree having a weight less than or equal to the weight of every other possible spanning tree. The weight of a spanning tree is the sum of weights given to each edge of the spanning tree.";
                return;
            }

            if (radioButton2.Checked == true)
            {
                textBox1.Text = "A Distributed File System (DFS) as the name suggests, is a file system that is distributed on multiple file servers or multiple locations. It allows programs to access or store isolated files as they do with the local ones, allowing programmers to access files from any network or computer. ";
                return;
            }

            if (radioButton3.Checked == true)
            {
                textBox1.Text = "Breadth-first search (BFS) is an algorithm for searching a tree data structure for a node that satisfies a given property. It starts at the tree root and explores all nodes at the present depth prior to moving on to the nodes at the next depth level.";
                return;
            }

            if (radioButton4.Checked == true)
            {
                textBox1.Text = "A directed graph is strongly connected if there is a path between all pairs of vertices. A strongly connected component (SCC) of a directed graph is a maximal strongly connected subgraph.";
                return;
            }
